...
//
//
//class PolynomailMultiplier {};
//
//class Polynomail :: PolynomailAdder, PolynomailMultiplier {
//
//};
...
/*
    ...
    list<Polynomial_part>zmienna_dod = adder.add(input.get_polynomial(),input2.get_polynomial());
    list<Polynomial_part>zmienna_odejm = subtractor.subtract(input.get_polynomial(),input2.get_polynomial());
    list<Polynomial_part>zmienna_skalar = scalar_mult.scalar_multiply(input.get_polynomial(), a);
    list<Polynomial_part>zmienna_mult = mult.multiply(input.get_polynomial(), input2.get_polynomial());
    list<Polynomial_part>zmienna_ord = ord.order(zmienna_mult);

    cout<<"___ADDER___"<<endl;
    for (list<Polynomial_part>::iterator i = zmienna_dod.begin(); i!=zmienna_dod.end();i++){
            cout<<"coeff:"<<(*i).get_coeff()<<"power: "<<(*i).get_power()<<endl;
        }
    cout<<"___SUBTRACT___"<<endl;
    for (list<Polynomial_part>::iterator i = zmienna_odejm.begin(); i!=zmienna_odejm.end();i++){
            cout<<"coeff:"<<(*i).get_coeff()<<"power: "<<(*i).get_power()<<endl;
    }
    cout<<"___SCALAR MULT___"<<endl;
    for (list<Polynomial_part>::iterator i = zmienna_skalar.begin(); i!=zmienna_skalar.end();i++){
            cout<<"coeff:"<<(*i).get_coeff()<<"power: "<<(*i).get_power()<<endl;
    }
    cout<<"___MULTIPLY___"<<endl;
    for (list<Polynomial_part>::iterator i = zmienna_mult.begin(); i!=zmienna_mult.end();i++){
            cout<<"coeff:"<<(*i).get_coeff()<<"power: "<<(*i).get_power()<<endl;
    }
    cout<<"____"<<endl;
    cout<<"___ORDERED MULTIPLICATION___"<<endl;
    for (list<Polynomial_part>::iterator i = zmienna_ord.begin(); i!=zmienna_ord.end();i++){
            cout<<"coeff:"<<(*i).get_coeff()<<"power: "<<(*i).get_power()<<endl;
    }
    cout<<"___ORDERED MULTIPLICATION X___"<<endl;
    check_for_given_x(zmienna_ord);
    print(zmienna_ord);
*/
